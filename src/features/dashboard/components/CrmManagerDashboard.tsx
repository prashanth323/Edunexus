    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-500">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <DashboardStatCard
          title="Total Leads"
          value={total}
          description={`${s.leads_this_month ?? 0} new this month`}
          icon={Users}
          color="violet"
        />
        <DashboardStatCard
          title="High Priority Open"
          value={s.high_priority_open ?? 0}
        ...
        <DashboardStatCard
          title="Admitted"
          value={s.leads_admitted ?? 0}
          description={`${s.admissions_this_month ?? 0} this month`}
          icon={UserCheck}
          color="violet"
        />
        <DashboardStatCard
          ...
          description={`${s.leads_lost ?? 0} leads lost`}
          icon={Target}
          color="purple"
        />
      </div>
