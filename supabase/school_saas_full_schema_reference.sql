...
-- REFERENCE DUMP ONLY — not loaded by Supabase CLI (keep outside migrations/).
-- Use supabase/migrations/01_*.sql … 12_*.sql in order for applies.
-- ============================================================
...
-- RLS helper functions are defined after public.profiles and public.user_roles (see below).
-- ============================================================
-- SCHOOL SAAS PLATFORM - SUPABASE POSTGRESQL SCHEMA
